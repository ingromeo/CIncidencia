...
if ($_POST['enviar'] != null) {
    ...
    $rpta = $pro->insertarestado($nombres, $estado);
    if ($rpta) {
        header("Location: ../view/ingestado.php?bien=".$ing);
           echo $ing;  
    } else {
        header("Location: ../view/ingestado.php?bien=".$rep);
           echo $rep;  
    }
}//fin guardar
...
if ($_POST['modificar'] != null) {
    ...
    $rptas = $pro->actualizarestado($idi, $nombresw, $estadow);
    if ($rptas) {
        header("Location: ../view/estado.php?bien=".$act);
        echo $act;
    } else {
        header("Location: ../view/ingestadoo.php");
    }
}//fin guardar
...
if ($accion = 'eliminar') {
    ...
    $rptas = $pro->eliminarestado($idi, $estadow);
    if ($rptas) {
        header("Location: ../view/estado.php?el=".$eli);
        echo $act;
    } else {
        header("Location: ../view/ingestado.php");
    }
}//fin guardar
if ($_POST['nuevo'] != null) {
    header("Location: ../view/ingestado.php");
