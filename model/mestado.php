...
class Estado {
    ...
    function insertarestado($nombres, $estado) {
        $rpta;
        try {
            ...
            $sql = "INSERT INTO estado (descripcion_estado, estado_estado)
    ...
    function actualizarestado($idi, $nombres, $estado) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
            ...
            mysql_query("BEGIN");
            //Elaboramos la sentencia
            $sql = "UPDATE estado SET descripcion_estado = '$nombres',
    ...
    function eliminarestado($idi, $estado) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
            ...
            mysql_query("BEGIN");
            //Elaboramos la sentencia
            $sql = "UPDATE estado SET estado_estado = '$estado'
                                         WHERE id_estado = $idi";
            //Ejecutamos la sentencia
            $result = mysql_query($sql);
            $rpta;
