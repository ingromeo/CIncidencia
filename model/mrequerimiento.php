...
class Requerimiento {
    ...
    function insertarrequerimiento($nombres,$fec1,$hora1,$fec2,$hora2,$canal,$solicitante,
    ...
    function actualizarrequerimiento($idi,$nombres,$fec1,$hora1,$fec2,$hora2,$canal,$solicitante,
                                $tipo,$est,$prioridad,$estado,$asu,$bien,$usuario) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
    ...
    function actualizarrequerimientoest($idi,$estado) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
    ...
    function eliminarrequerimiento($idi, $estado) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
    ...
    function buscarrequerimiento($id) {
    ...
    function listarreq($id) {

        //Le deciamos que la locacion es lenguaje espa?ol
        setlocale(LC_CTYPE, 'es');
        //La sentencia a ejecutar
        $sql = "SELECT i.id_incidencia as codigo,
                       i.descripcion_incidencia as requerimiento,
                ...
                WHERE i.estado_incidencia = 1 AND i.tipo_incidencia = 'requerimiento'
...
function listarcliente() {
    ...
    function listarresponsable() {
        ...
        setlocale(LC_CTYPE, 'es');
        //La sentencia a ejecutar
        $sql = "select concat(p.nombres_persona,' ',p.apepat_persona,' ',p.apeat_persona) as responsable, u.id_usuario as idusuario from usuario u inner join tipousuario t on u.id_tipousuario = t.id_tipousuario inner join persona p on p.id_persona = u.id_persona where u.estado_usuario = 1";
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
            //Obtenemos la conexion
    ...
    /*==========================================================================================*/
    function insertardiag($diag,$fec1,$hora1, $id) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
            ...
            //$this->codigoProducto =$this->codigoSiguiente($cn);
            //Elaboramos la sentencia
            $sql = "INSERT INTO diagnostico (descripcion_diagnostico,
                                            fecha_diagnostico,
                                            hora_diagnostico,
                                            id_incidencia)
                                VALUES('$diag',
    ...
    function actualizardiag($id, $fec1, $hora1, $est, $estado) {
        $rpta;
        try {
            //Creamos un objeto de la clase conexion
            //$miconexion = new Conexion();
            ...
            mysql_query("BEGIN");
            //Elaboramos la sentencia
            $sql = "UPDATE incidencia SET ffin_incidencia = '$fec1',
                                          hfin_incidencia = '$hora1',
