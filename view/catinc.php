...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/catinccon.php" method="POST">  

            <div class="box-header" align="center">
                <h3 class="box-title">GESTION DE CATEGOR&Iacute;AS DE INCIDENCIAS</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
                    <a href="../reportes/reportejas/jasper/rcatinc.php?rep=catinc" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updcatinc.php?id=".$lista[$i]['id_catinc'];
                        $dirEliminar="../controller/catinccon.php?accion=eliminar&idqwe=".$lista[$i]['id_catinc'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_catinc']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_catinc']); ?></td>
