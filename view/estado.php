...
<html>
    ...
    <br/>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/estadocon.php" method="POST">
       ...
       <div align ="left">
                    ...
                    <a href="../reportes/reportejas/jasper/restado.php?rep=estado" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updestado.php?id=".$lista[$i]['id_estado'];
                        $dirEliminar="../controller/estadocon.php?accion=eliminar&idqwe=".$lista[$i]['id_estado'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_estado']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_estado']); ?></td>
