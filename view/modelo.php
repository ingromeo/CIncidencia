...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/modelocon.php" method="POST">

            <div class="box-header" align="center">
                <h3 class="box-title">GESTION DE MODELOS</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
                    <a href="../reportes/reportejas/jasper/rmodelo.php?rep=modelo" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updmodelo.php?id=".$lista[$i]['id_modelo'];
                        $dirEliminar="../controller/modelocon.php?accion=eliminar&idqwe=".$lista[$i]['id_modelo'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_modelo']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_modelo']); ?></td>
