...
<head>
   ...
   //alert(ObjetoTR.cells[6].childNodes[0].nodeValue);
   document.getElementById('diag').value = ObjetoTR.cells[6].childNodes[0].nodeValue;
}
        </script>
...
<body>
<center>
<table align='center' id="example1" border='1' width='50%' class='table table-bordered table-striped'>
    <tr>
    <td style="background-color: #1fbba6; color: white;">Responsable</td>
    <td style="background-color: #1fbba6; color: white;">C. Inc.</td>
    <td style="background-color: #1fbba6; color: white;">A. Inc.</td>
    <td style="background-color: #1fbba6; color: white;">Fecha</td>
    <td style="background-color: #1fbba6; color: white;">Hora</td>
    <td style="background-color: #1fbba6; color: white;">C. Inc.</td>
    <td style="background-color: #1fbba6; color: white;">Diagn&oacute;stico</td>
    </tr>
    <?php foreach ($rp as $row){ ?>
    	<tr onclick='muestra(this)'>
        <td><?php echo $row['responsable']?></td>
        <td><?php echo $row['catinc']?></td>
        <td><?php echo $row['asuinc']?></td>
        <td><?php echo $row['fecha']?></td>
        <td><?php echo $row['hora']?></td>
        <td><?php echo $row['codigoinc']?></td>
        <td><?php echo $row['diagn']?></td>
        </tr>
<?php } ?>   
    </table>
    </center>
