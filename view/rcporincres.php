...
<html>
    <head>
        ...
        /*jQuery.noConflict();
            jQuery(document).ready(function () {
                jQuery("#rProducto").click(function (event) {
                    ...
                    jQuery("#capa1").load("../controller/rcporincrescon.php", {datei:datei,datef:datef}, function (response, status, xhr) {
                        if (status == "error") {
                            var msg = "Error!, No se pudo cargar la pagina ";
                            var res=
                            jQuery("#capa1").html(msg + xhr.status + " " + xhr.statusText);
                        }
                    });
                });
            });*/
        ...
        function valida_envia(){
          ...
          if (datei.length == 0 && datef.length == 0) {
                    ...
                    if (datei > datef) {
                       ...
                       $.ajax({
                       type: "POST",
                              url: "../controller/rcporincrescon.php",
                              data: $('#re').serialize(),
                              success: function(a) {
                                var a=a.split('</html>');
                                //alert(a[1]);
    ...
    <center>
        <table align="center" cellspacing="2" cellpadding="4" border="0" class="borde_table" width="50%">
                <tr>
                    <td colspan="4" align="center" height="20" bgcolor="#1fbba6" style="color:#FFF;">REPORTE DE PORCENTAJE DE INCIDENCIAS RESUELTOS</td>
                </tr>
                <tr><form id="re" name="re">
           ...
           <br/>
            ...
            <button style="display: none;" type="submit" name="cancelar" id="cancelar">Atras</button>
            <button type="submit" name="nuevo" id="nuevo" onClick=" window.location.href='rcporincres.php' ">Nuevo</button>
            
            </p>
            <div id="capa1" align = 'center' style="display: none;">
        
        <div>
        <form action="../reportes/reportepdf/rrcporincres.php" method="POST" target="_blank">
           ...
           <input type="submit" name="enviar" id="enviar" value="Reporte" />
                ...
                <div id="bloque">
                <div class="A">
                <img alt="" src="../img/inc1.jpg" height="140px" height="140px"/>
                </div>                
                <div class="B">
                <br /><br /><br /><br />
       ...
       function dato(){
        ...
        $(function () {
                ...
                var donut = new Morris.Donut({
                    ...
                    data: [
                        {label: "Inc. Resueltas", value: punto1},
