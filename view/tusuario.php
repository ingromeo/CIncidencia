...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/tusuariocon.php" method="POST">  
            <div class="box-header" align="center">
                <h3 class="box-title">GESTION DE TIPO DE USUARIOS</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
                    <a href="../reportes/reportejas/jasper/rtusuario.php?rep=tusuario" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updtusuario.php?id=".$lista[$i]['id_tipousuario'];
                        $dirEliminar="../controller/tusuariocon.php?accion=eliminar&idqwe=".$lista[$i]['id_tipousuario'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_tipousuario']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_tipousuario']); ?></td>
