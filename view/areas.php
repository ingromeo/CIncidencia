...
<html>
    ...
    <?php
        ...
        <div class='alert alert-success'><?php echo $el; ?>
                  ...
                  ?>
                  <br /><br />
        <form action="../controller/areascon.php" method="POST">
            <div class="box-header" align="center">
                <h3 class="box-title">GESTION DE &Aacute;REAS</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
					<a href="../reportes/reportejas/jasper/rareas.php?rep=areas" target="_blank">Reporte</a>
</div>
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updareas.php?id=".$lista[$i]['id_areas'];
                        $dirEliminar="../controller/areascon.php?accion=eliminar&idqwe=".$lista[$i]['id_areas'];
                        ?>

                        <tr>
                            <td><? echo ($lista[$i]['id_areas']); ?></td>
                            <td><? echo ($lista[$i]['descripcion_areas']); ?></td>
