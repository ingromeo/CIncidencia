...
<html>
    ...
    <body onLoad="redimensiona();" class="blurBg-false">
        ...
        <form method="POST" action="../controller/marcacon.php" class="formoid-solid-green" style="background-color:#FFFFFF;font-size:12px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:500px;min-width:50px">
            <table align="center" cellspacing="2" cellpadding="4" border="0" class="borde_table" width="80%">
                <tr>
                    <td colspan="2" height="54" bgcolor="#1fbba6" style="color:#FFF;">&nbsp;&nbsp;INGRESO DE MARCAS</td>
                </tr>
...
<div class="element-input">      
    <div class="item-cont">
      <input type="text" class="large" name="nombres" id="nombres" required="required" placeholder="Ingrese marca"/>
...
<?php
        ...
        <a href="marca.php"><img src="../img/check.png" width="25px" height="25px"/></a>
        </div> </div> </center>
                    <?php
                  } 
                  ?>
