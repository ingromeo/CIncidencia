...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/personacon.php" method="POST">
       ...
       <div align ="left">
                    ...
                    <a href="../reportes/reportejas/jasper/rpersona.php?rep=persona" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updpersona.php?id=".$lista[$i]['id_persona'];
                        $dirEliminar="../controller/personacon.php?accion=eliminar&idqwe=".$lista[$i]['id_persona'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_persona']); ?></td>
                            <td align="center"><? echo ($lista[$i]['nombres_persona']); ?></td>
