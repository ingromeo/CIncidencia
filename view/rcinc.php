        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#rProducto").click(function (event) {
                    ...
                    $("#capa1").load("../controller/rcinccon.php", {datei:datei,datef:datef,
...
<script type="text/javascript">
             ...
             function dato3 (){                
                var f1 = document.getElementById('cati').value;
                document.getElementById('t3').value = f1;
             }
             function dato4 (){                
                var f1 = document.getElementById('asu').value;
                document.getElementById('t4').value = f1;
             }
             function dato5 (){                
                var f1 = document.getElementById('responsable').value;
                document.getElementById('t5').value = f1;
             }
             function dato6 (){                
                var f1 = document.getElementById('estado').value;
                document.getElementById('t6').value = f1;
             }
             function dato7 (){                
                var f1 = document.getElementById('prioridad').value;
                document.getElementById('t7').value = f1;
             }
             </script>
  ...
  <div align="center">	
          ...
          <table align="center" cellspacing="2" cellpadding="4" border="0" class="borde_table" width="80%">
                <tr>
                    <td align="center" colspan="4" height="10" bgcolor="#1fbba6" style="color:#FFF;">INCIDENCIAS</td>
                </tr>
                <tr align="center">
                    <td style="width:150px;" class=" border-bottom"> <span class="style1">F. Inicio:</span> </td>
                    <td style="width:150px;" class=" border-bottom"><input type="date" name="datei" id="datei" style="width:250px;" onchange="fecha1()"/></td>
                    <td style="width:150px;" class=" border-bottom"> <span class="style1">F. Fin:</span> </td>
                    <td style="width:150px;" class=" border-bottom"><input type="date" name="datef" id="datef" style="width:250px;" onchange="fecha2()"/></td>
                </tr>                
                <tr align="center">
                    <td height="50" class=" border-bottom"> <span class="style1">C. Asunto:</span> </td>
                    <td class=" border-bottom"><select id="cati" name="cati" onchange="dato3()">
                    ...
                    <td class=" border-bottom"><select id="asu" name="asu" onchange="dato4()">
                    <option value=" ">Seleccione...</option><?php
                ...
                <tr align="center">
                    ...
                    <td class=" border-bottom"><select id="responsable" name="responsable" onchange="dato5()">
                    <option value=" ">Seleccione...</option><?php
                ...
                <tr align="center">
                    ...
                    <td class=" border-bottom"><select id="estado" name="estado" onchange="dato6()">
                    <option value=" ">Seleccione...</option><?php
                    ...
                    <td class=" border-bottom"><select id="prioridad" name="prioridad" onchange="dato7()">
                           <option value=" ">Seleccione...</option><?php
            ...
            <br/>
            <button type="submit" name="rProducto" id="rProducto">Buscar</button>
            <div>
        <form action="../reportes/reportepdf/rincidencia.php" method="POST" target="_blank">
           ...
           <input style="display: none;" type='text' id='t7' name='t7'/>
