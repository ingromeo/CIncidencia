...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/marcacon.php" method="POST">
       ...
       <div align ="left">
                    ...
                    <a href="../reportes/reportejas/jasper/rmarca.php?rep=marca" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updmarca.php?id=".$lista[$i]['id_marca'];
                        $dirEliminar="../controller/marcacon.php?accion=eliminar&idqwe=".$lista[$i]['id_marca'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_marca']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_marca']); ?></td>
