...
function ocombo() {
  ...
  $(document).ready(function(){
    ...
    <body onLoad="redimensiona();" class="blurBg-false">
        ...
        <form method="POST" action="../controller/tecnicoicon.php" class="formoid-solid-green" style="background-color:#FFFFFF;font-size:12px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:500px;min-width:50px">
            <table align="center" cellspacing="2" cellpadding="4" border="0" class="borde_table" width="80%">
                ...
                <tr style="display: none;">
                    ...
                    <td class=" border-bottom"><input type="text" name="estado" id="estado" value="2" style="width:50px;"/></td>
    ...
    <div class="item-cont">
      <input class="large" type="text" name="demo" id="demo" value="" required="required" placeholder="demo"/>
        <span class="icon-place"></span>
                ...
                <option value="<?php echo ($lie[$a]['nivel_nivel']); ?>">
                <?php echo ($lie[$a]['descripcion_nivel']); ?></option>
                <?php } ?>		
                </select>
                ...
                <tr>                    
                <td><span class="style2">&nbsp;</span>Responsable:</td>
                <td style="width:250px;">                
                <div class="element-select">
                <label class="title"></label>
                <div class="item-cont">
