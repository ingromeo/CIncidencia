...
<div class="box-body">
<table align='center' bgcolor="#1fbba6" border='1' width='50%' id="example1" class="table table-bordered table-striped">
<tr height='50'>      
      <td style="background-color: #1fbba6; color: white;">C. Bien</td>
      <td style="background-color: #1fbba6; color: white;">Codigo</td>
      <td style="background-color: #1fbba6; color: white;">Serie</td>
      <td style="background-color: #1fbba6; color: white;">Des. Bien</td>
      <td style="background-color: #1fbba6; color: white;">Precio</td>
      <td style="background-color: #1fbba6; color: white;">Fecha</td>
      <td style="background-color: #1fbba6; color: white;">Hora</td>
      <td style="background-color: #1fbba6; color: white;">Cantidad</td>
      <td style="background-color: #1fbba6; color: white;">Modelo</td>
      <td style="background-color: #1fbba6; color: white;">Marca</td>
</tr>
...
<center><div id="pgrNavegador" style="width: 200px;"></div></center>
        ...
        <script type="text/javascript">
            <!--
            var pager = new Pager('example1', 8);
            pager.init();
