        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#rProducto").click(function (event) {
                    ...
                    $("#capa1").load("../controller/consulta.php", {datei:datei,datef:datef,
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>	
                        ...
                        $dirEstados="updestadosr.php?id=".$lista[$i]['codigo'];
...
<!-- menu perndientes *********************************************************************************-->
	   ...
	   <div class="pestana" id="tab-2">
          ...
          <table align="center" cellspacing="2" cellpadding="4" border="1" class="borde_table" width="55%">
                <tr>
                ...
                <tr align="center">
                    ...
                    <td class=" border-bottom"><input type="date" name="datei" id="datei" style="width:150px;"/></td>
                    <td height="50" class=" border-bottom"><span class="style2">*</span> <span class="style1">F. Fin:</span> </td>
                    <td class=" border-bottom"><input type="date" name="datef" id="datef" style="width:150px;"/></td>
                </tr>                
                <tr align="center">
