...
<html>
    <head>
        <meta charset="utf-8" />
	<title>INGRESO DE REQUERIMIENTO</title>
...
<style type="text/css">
    ...
    <body onLoad="redimensiona();" class="blurBg-false">
        <form method="POST" action="../controller/requerimientocon.php" class="formoid-solid-green" style="background-color:#FFFFFF;font-size:12px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:710px;min-width:210px">
            
            <div class="title" align="center"><h2>INGRESO DE REQUERIMIENTO</h2></div>
...
<div class="element-input">      
    <div class="item-cont">
      <input class="large" type="text" name="tipo" id="tipo" value="requerimiento" required="required" placeholder="Tipo"/>
...
<div class="element-input">      
    <div class="item-cont">
      <textarea class="small" name="nombres" id="nombres" cols="20" rows="5" required="required" placeholder="Ingrese Requerimiento"></textarea>
        <span class="icon-place"></span>
    </div>
    </div>
    </td>
            ...
            <div class="submit" align="center">
                <p align="center">
                <form method="POST" action="../controller/requerimientocon.php">
        ...
        <a href="requerimiento.php"><img src="../img/check.png" width="25px" height="25px"/></a>
        </div> </div> </center>
                    <?php
                  } 
                  ?>   
