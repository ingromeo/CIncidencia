...
<div class="element-input">      
    <div class="item-cont">
      <textarea class="small" name="nombres" id="nombres" cols="3" rows="15" required="required" placeholder="Ingrese incidencia"></textarea>
        <span class="icon-place"></span>
    </div>
    </div>
    </td>                          
        ...
        <a href="incidencia.php"><img src="../img/check.png" width="25px" height="25px"/></a>
        </div> </div> </center>
                    <?php
                  } 
                  ?> 
