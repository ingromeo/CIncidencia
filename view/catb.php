...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/catbcon.php" method="POST">

            <div class="box-header" align="center">
                <h3 class="box-title">CATEGOR&Iacute;AS DE BIENES</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
                    <a href="../reportes/reportejas/jasper/rcatb.php?rep=catb" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updcatb.php?id=".$lista[$i]['id_catb'];
                        $dirEliminar="../controller/catbcon.php?accion=eliminar&idqwe=".$lista[$i]['id_catb'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_catb']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_catb']); ?></td>
