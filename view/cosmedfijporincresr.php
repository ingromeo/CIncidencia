...
<head>
	<meta charset="UTF-8"/>
        ...
        function Pager(tableName, itemsPerPage) {
            ...
            this.cantidadDivs=100;//cantidad de divisores a mostrar por paginador
...
<table id='tblDatos' align='center' border='1' width='50%' class='table table-bordered table-striped'>
<tr height='50' bgcolor="#1fbba6">
<td style="background-color: #1fbba6; color: white;">C. Inc.</td>
      <td style="background-color: #1fbba6; color: white;">Descripci&oacute;n</td>
      ...
      <td style="background-color: #1fbba6; color: white;">Personal</td>
      <td style="background-color: #1fbba6; color: white;">T&eacute;cnico</td>
      <td style="background-color: #1fbba6; color: white;">Estado</td>
      <td style="background-color: #1fbba6; color: white;">Costo</td>
</tr>
...
<center><div id="pgrNavegador" style="width: 200px;"></div></center>
        ...
        <script type="text/javascript">
            <!--
            var pager = new Pager('tblDatos', 6);
            pager.init();
