...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/distritocon.php" method="POST">

            <div class="box-header" align="center">
                <h3 class="box-title">GESTION DE DISTRITOS</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
                    <a href="../reportes/reportejas/jasper/rdistrito.php?rep=distrito" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="upddistrito.php?id=".$lista[$i]['id_distrito'];
                        $dirEliminar="../controller/distritocon.php?accion=eliminar&idqwe=".$lista[$i]['id_distrito'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_distrito']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_distrito']); ?></td>
