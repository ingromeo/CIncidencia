...
<html>
    ...
    <body>
        ...
        <div class='alert alert-success'><?php echo $sal; ?>
                  ...
                  ?>
        <form action="../controller/prioridadcon.php" method="POST">

            <div class="box-header" align="center">
                <h3 class="box-title">GESTION DE PRIORIDAD</h3>
                <br />
       <div align ="left">
                    <input type="submit" id="nuevo" name="nuevo" value="Nuevo"/>
                    <a href="../reportes/reportejas/jasper/rprioridad.php?rep=prioridad" target="_blank">Reporte</a>
                </div>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        $dirModifica="updprioridad.php?id=".$lista[$i]['id_prioridad'];
                        $dirEliminar="../controller/prioridadcon.php?accion=eliminar&idqwe=".$lista[$i]['id_prioridad'];
                        ?>
                        <tr>
                            <td align="center"><? echo ($lista[$i]['id_prioridad']); ?></td>
                            <td align="center"><? echo ($lista[$i]['descripcion_prioridad']); ?></td>
