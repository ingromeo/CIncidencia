        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $("#rProducto").click(function (event) {
                    ...
                    $("#capa1").load("../controller/ricon.php", {datei:datei,datef:datef,
	...
	<ul class="tabs">
	   ...
	   <div class="pestana" id="tab-1">
        ...
        <div class='alert alert-success'><?php echo $el; ?>
                  ...
                  ?>
        <form action="../controller/incidenciacon.php" method="POST">  
       ...
       <div align ="left">
                    ...
                    <a href="../reportes/reportejas/jasper/rincidencia.php?rep=incidencia" target="_blank">Reporte</a>
                     </div>  
            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>	
                        ...
                        $dirTecnico="tecnicoi.php?id=".$lista[$i]['codigo'];
                        $dirModifica="updincidencia.php?id=".$lista[$i]['codigo'];
                        ...
                        <tr>
                            ...
                            <td align="center"><? echo ($lista[$i]['incidencia']); ?></td>
...
<script type="text/javascript">
function fec1(){
    var fec1 = document.getElementById('datei').value;
    document.getElementById('r1').value = fec1;
}
function fec2(){
    var fec2 = document.getElementById('datef').value;
    document.getElementById('r2').value = fec2;
}
</script>
	   </div>
	   <div class="pestana" id="tab-2">
          ...
          <table align="center" cellspacing="2" cellpadding="4" border="0" class="borde_table" width="80%">
                ...
                <tr align="center">
                    ...
                    <td style="width:150px;" class=" border-bottom"><input type="date" name="datei" id="datei" style="width:250px;" onchange="fec1()" required="required"/></td>
                    <td style="width:150px;" class=" border-bottom"> <span class="style1">F. Fin:</span> </td>
                    <td style="width:150px;" class=" border-bottom"><input type="date" name="datef" id="datef" style="width:250px;" onchange="fec2()" required="required"/></td>
                </tr>                
                <tr align="center">
