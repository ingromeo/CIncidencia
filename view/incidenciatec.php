            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>	
                        ...
                        $dirEstados="updestadosi.php?id=".$lista[$i]['codigo'];
                        ...
                        <tr>
                            ...
                            <td width="9%" align="center">
                                <a href="<?php echo $dirEstados; ?>">
                                    <img src="../img/estados.png" width="15%" height="15%" alt="Editar pregunta del sistema"  border="0"/></a>
